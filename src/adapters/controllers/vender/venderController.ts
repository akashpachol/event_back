...
import {
  ...
  VenderWithIdGet,
  verifyVenderGet,
  verifyVenderWithIdGet,
} from "../../../application/use-cases/vender/get";
...
import {
  ...
  venderTypeEdit,
  verifyVender,
} from "../../../application/use-cases/vender/edit";
...
export const venderController = (
  ...
  const addVender = expressAsyncHandler(async (req: Request, res: Response) => {
  ...
  const EditVenderType = expressAsyncHandler(
    async (req: Request, res: Response) => {
      ...
      const response = await venderTypeEdit(
        venderTypeid,
        venderType,
        repository
      );
  ...
  const getVenderType = expressAsyncHandler(
    async (req: Request, res: Response) => {
  ...
  const handleBlockVenderType = expressAsyncHandler(
    async (req: Request, res: Response) => {
      ...
      const { event, message } = await VenderTypeBlock(
        vendertypetId,
        repository
      );
  ...
  const getVenderWithId = expressAsyncHandler(
    async (req: Request, res: Response) => {
      const venderId: string = req.params.venderId;

      const data = await VenderWithIdGet(
        venderId,
        repository,
        dbRepositoryUser
      );
  ...
  const venderVerify = expressAsyncHandler(
    async (req: Request, res: Response) => {
  ...
  const getVerifyVender = expressAsyncHandler(
    async (req: Request, res: Response) => {
  ...
  const filterVender = expressAsyncHandler(
    async (req: Request, res: Response) => {
  ...
  const getVerifyVenderWithId = expressAsyncHandler(
    async (req: Request, res: Response) => {
      const venderId: string = req.params.venderId;
