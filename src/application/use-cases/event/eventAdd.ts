...
export  const eventAdd=async (event:{
name:string,
description:string,
image:string,
},
repository:ReturnType<eventRepositoryMongoDBType>)=>{
  console.log(event,"jhfjhfgsfsgjh");
...
export  const eventGet=async (
  ...
  export const eventBlock =async ( eventId: string,  repository:ReturnType<eventRepositoryMongoDBType>) => {
  ...
  export  const eventEdit=async (id:string,event:{
    name:string,
    description:string,
    image:string,
    },
